...
export default function Home() {
  return (
    <main className="min-h-screen bg-gridwars-bg px-6 py-8 text-gridwars-text">
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        <header className="flex items-center justify-between border-b border-gridwars-border pb-4">
          <div>
